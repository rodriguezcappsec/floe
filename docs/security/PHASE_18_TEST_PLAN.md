...
| 18M | — | — | — | DEFERRED by product decision; no restricted application-launch runtime exists. | Ordinary Open/Open With remain unchanged and must not be described as sandboxed. |
