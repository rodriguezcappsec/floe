...
| 12F — Action integration | NEXT | `phase-12f-productivity-actions` | Context, palette and shortcut integration without a menu wall. | 11A/12A–E; verify eligibility and pointer/keyboard parity. |
