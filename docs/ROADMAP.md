...
| 6S — File watching | NEXT | `phase-6s-file-watching` | Coalesced external-change reconciliation, refresh, selection/scroll restoration. | 6P/6R; no integrity-monitoring claim; verify storms, deletion, rename and 100k folders. |
