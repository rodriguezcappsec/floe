...
| 8E — Cross-column drag | NEXT | `phase-8e-miller-drag-drop` | Drag/drop and hover navigation across columns, sidebar, tabs and panes. | 6R/8D; verify modifiers, autoscroll and no silent overwrite. |
