...
| 9D — Audio/video | NEXT | `phase-9d-preview-media` | Playback, seeking, metadata and poster frames. | 9A/6L; no codec installer; verify retired sources and resource release. |
