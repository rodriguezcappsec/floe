...
| 9E — Fonts/archives | NEXT | `phase-9e-preview-fonts-archives` | Read-only font specimen and bounded archive listing. | 9A; no install/extract; verify bombs, traversal and malformed fonts. |
