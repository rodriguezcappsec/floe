...
| Phase | Status | Recommended branch | Scope | Dependencies; exclusions; acceptance |
| --- | --- | --- | --- | --- |
| 11A — Command registry | NEXT | `phase-11a-command-registry` | Human-named commands, eligibility, shortcut and menu metadata. | Reuse app actions; no business-logic duplication; verify registry/action parity. |
