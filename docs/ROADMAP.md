...
| 8C — Keyboard/trackpad | NEXT | `phase-8c-miller-navigation` | Left/right, up/down and smooth horizontal trackpad interaction. | 8B; Vim stays 11D; verify RTL, focus, reduced motion and native smoke. |
