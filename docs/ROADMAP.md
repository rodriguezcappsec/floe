...
| 8D — Column actions | NEXT | `phase-8d-miller-actions` | Selection-aware normal context actions in every column. | 8B/6P/6Q; verify exact active-column ownership and parity. |
