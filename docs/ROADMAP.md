...
| Phase | Status | Recommended branch | Scope | Dependencies; exclusions; acceptance |
| --- | --- | --- | --- | --- |
| 13A — Folder filter | NEXT | `phase-13a-folder-filter` | Instant text/glob/regex filtering, count and Escape clear. | 6T; not recursive search; verify invalid patterns, focus and large folders. |
