...
| 11D — Optional Vim mode | NEXT | `phase-11d-vim-mode` | Opt-in list/grid/Miller navigation mappings. | 11C/8C; never default; verify input fields and mode/focus transitions. |
