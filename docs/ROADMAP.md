...
| 6R — Drag and drop | NEXT | `phase-6r-drag-drop` | Internal/external drag, sidebar/Trash, modifiers, hover-open, autoscroll, highlighting. | 6O–6Q; no implicit overwrite; verify exact destinations and keyboard alternatives. |
