...
| 10D — Permissions | NEXT | `phase-10d-permissions` | Executable, mode and explicit owner/group editing with recursive preflight. | 10C/6P; no root-process elevation; verify symlinks and partial failure. |
