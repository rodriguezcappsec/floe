...
| 9C — PDF/documents | NEXT | `phase-9c-preview-documents` | Passive PDF and reviewed office/document rendering. | 9A/provider review; no macros; verify malformed documents, limits and cancellation. |
