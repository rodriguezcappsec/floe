...
| 13D — Content search | NEXT | `phase-13d-content-search` | Opt-in bounded text search with glob/regex/case controls. | 13B/13C; no binary/secret upload; verify encodings, permission and cancellation. |
