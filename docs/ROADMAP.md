...
| 7E — Split interaction | NEXT | `phase-7e-split-interaction` | Toggle, close, swap, switch side, opposite-pane open and search/filter hooks. | 7D; no drag; active side uses non-color semantics and passes native smoke. |
