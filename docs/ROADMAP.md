...
| 10E — Checksums | NEXT | `phase-10e-checksums` | SHA-256, SHA-512, legacy-labelled MD5, expected-digest verification. | Job boundary; no authenticity claim; verify vectors, huge files and cancellation. |
