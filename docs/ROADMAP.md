...
| 10C — Properties | NEXT | `phase-10c-properties` | General, Open With, filesystem, mount and aggregate properties. | 10A/10B/5D; verify multi-item truth and native dialog smoke. |
