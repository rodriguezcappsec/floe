...
| 18M — Open Safely | NEXT | `phase-18m-open-safely` | Constrained external launch with reviewed mechanism and persistent indicator. | 18L/14; never silently launch normally; verify policy, fallback, compatibility. |
