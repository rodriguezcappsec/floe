...
- [x] N1: Preference leaf reports all gates met.
  CHECK: node <unlazy-skill-dir>/scripts/gate-check.mjs --status gates/leaf-6k2-1.1.1.md
  EXPECT: /ALL MET/
...
- [x] N2: Privileged-browsing security design leaf reports all gates met.
  CHECK: node <unlazy-skill-dir>/scripts/gate-check.mjs --status gates/leaf-6k2-1.1.2.md
  EXPECT: /ALL MET/
